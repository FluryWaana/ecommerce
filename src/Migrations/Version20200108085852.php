 ...
 */
final class Version20200108085852 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie_avoir_nom_caracteristique DROP FOREIGN KEY FK_EBC113EB6FB990BC');
        ...
        $this->addSql('ALTER TABLE article_caracteristique DROP FOREIGN KEY FK_328A8E1574961937');
        ...
        $this->addSql('ALTER TABLE article_caracteristique DROP FOREIGN KEY FK_328A8E152CD38585');
        $this->addSql('ALTER TABLE categorie_avoir_nom_caracteristique DROP FOREIGN KEY FK_EBC113EB2CD38585');
